...
import { LogIn, UserPlus, Home, AlertCircle, CheckCircle2, Loader } from 'lucide-react';
import { doc, setDoc } from 'firebase/firestore'; 

const AuthPage = ({ navigateTo, t, redirectPath }) => { // NEU: redirectPath als Prop hinzugefügt
  ...
  const handleAuth = async (e) => {
    ...
    if (isLogin) {
      try {
        ...
        navigateTo(redirectPath || 'navigation'); // NEU: Nutze redirectPath oder Standard 'navigation'
      } catch (error) {
