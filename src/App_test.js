      ...
      <div className="App">
        ...
        <BrowserRouter>
          ...
          <div>
            ...
            <p>HomePage, InfoPage, NavigationPage, AdminPanelPage, ManagePlayersPage, ManageRanksPage, ManageTroopStrengthsPage, ManageNormsPage, ManageChestMappingPage, AdminRegistrationPage, ManageAdminRequestsPage, CreatePeriodPage, ContactFormPage, ComingSoonPage, AdminLoginPage, CurrentTotalEventPage</p>
          </div>
        </BrowserRouter>
      </div>
    </AuthProvider>
